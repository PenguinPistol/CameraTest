...
import me.penguinpistol.cameratest.databinding.FragmentTakePictureV2SelectPhotoBinding;
...
public class TakePictureSelectPhotoFragment extends Fragment {

    private FragmentTakePictureV2SelectPhotoBinding mBinding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        mBinding = FragmentTakePictureV2SelectPhotoBinding.inflate(inflater, container, false);
        ...
        mBinding.btnUsePhoto.setOnClickListener(v -> {
            ...
            mViewModel.setAnalysisParameter(dir, select);
            ...
            switch (dir) {
                ...
                case RIGHT_45:
                    ...
                    mViewModel.getNavController().navigate(R.id.action_result);
                    return;
            }
    ...
    private void photoClick(FaceDirection dir) {
        ...
        Uri imageUri = mViewModel.getAnalysisParameter().getImageUri(dir);
        if(imageUri != null) {
